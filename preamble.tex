...
\usepackage{multirow}
\usepackage{multicol}
\usepackage{makecell} % \makecell{text \\ newline} для длинных строк
...
\newcolumntype{C}[1]{>{\centering\arraybackslash}m{#1}} % новый тип колонки в таблицах с центрированием по высоте и ширине (allign-left)
